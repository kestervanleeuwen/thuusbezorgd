package nl.hu.inno.thuusbezorgd.order.infrastructure.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import nl.hu.inno.thuusbezorgd.order.infrastructure.driven.messaging.RabbitMqEventPublisher;
